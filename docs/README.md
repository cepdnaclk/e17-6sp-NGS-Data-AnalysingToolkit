...
We are propossing different kinds of feature selection methods & classification insted of specific one.
So, the user can tryout different methods and can comeup with a most accurate one.
